  ...
  return (
    <main className="min-h-screen bg-gray-950 text-white p-6">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-2xl font-bold text-white">VWH Task Command</h1>
      ...
      <div className="flex flex-wrap gap-3 mb-6">
        <select
          ...
          className="bg-gray-800 text-white text-sm rounded px-3 py-2 border border-gray-700 focus:outline-none"
        >
